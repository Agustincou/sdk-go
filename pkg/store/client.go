...
type Client interface {
	...
	Get(ctx context.Context, userID, externalStoreID string) (*SearchResponse, error)
}
...
func (c *client) Get(ctx context.Context, userID, externalStoreID string) (*SearchResponse, error) {
	requestData := httpclient.RequestData{
